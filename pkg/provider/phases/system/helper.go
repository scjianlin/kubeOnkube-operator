...
function Update_yumrepo(){
    ...
    #Set the YUM configuration file successfully.cat << EOF > /etc/yum.repos.d/dmall-yum-bk.repo
    cat << EOF | tee /etc/yum.repos.d/dmall-bk.repo
[app]
name=yum.bk.dmall.com app repo
baseurl=http://yum.bk.dmall.com/app/\$releasever/
enabled=1
gpgcheck=0
[sys]
name=yum.bk.dmall.com sys repo
baseurl=http://yum.bk.dmall.com/sys/\$releasever/
enabled=1
gpgcheck=0
[kernel]
name=Dmall.Inc Linux Kernel Repository - el7
baseurl=http://yum-mirrors.dmall.com/centos/7/kernel/el7/x86_64/RPMS
enabled=1
gpgcheck=0
EOF
...
# Generated by KOPS tasks.
options timeout:1 attempts:1
#nameserver  10.27.255.110
nameserver  10.27.0.203
nameserver  10.27.0.3
EOF
