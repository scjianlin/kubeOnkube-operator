...
// func completeGPU(cluster *provider.Cluster) error {
...
func completeAddresses(cluster *provider.Cluster) error {
	...
	if cluster.Spec.Features.HA != nil {
		if cluster.Spec.Features.HA.TKEHA != nil {
			cluster.AddAddress(devopsv1.AddressAdvertise, cluster.Spec.Features.HA.TKEHA.VIP, 6443)
		}
...
// func (p *Provider) EnsureGalaxy(ctx context.Context, c *devopsv1.Cluster) error {
...
// func (p *Provider) EnsureCNIPlugins(ctx context.Context, c *provider.Cluster) error {
...
// func (p *Provider) EnsureNvidiaDevicePlugin(ctx context.Context, c *provider.Cluster) error {
...
// func (p *Provider) EnsureGPUManager(ctx context.Context, c *provider.Cluster) error {
// 	if c.Cluster.Spec.Features.GPUType == nil {
// 		return nil
// 	}
//
...
// func (p *Provider) EnsureCSIOperator(ctx context.Context, c *provider.Cluster) error {
