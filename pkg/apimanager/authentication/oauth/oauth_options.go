...
import (
	"errors"
	"github.com/gostship/kunkka/pkg/util/sliceutil"
	"net/url"
	"time"
)
...
type Client struct {
	// The name of the OAuth client is used as the client_id parameter when making requests to <master>/jwt/authorize
	// and <master>/jwt/token.
	Name string
